package com.catcreaft.tyche.features.qqAi;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.catcreaft.tyche.util.StringUtil;
 ...
 *
 * @author Heilant Gong
 *     <p>{@link this#getSign(TreeMap)} 获取sing接口授权 详见 https://ai.qq.com/doc/auth.shtml {@link
 *     this#getTalk(String, String)} 访问接口 获取聊天内容
 */
@Component
public class QQAiTalk {
  @Resource private StringUtil stringUtil;
  ...
  private String getSign(TreeMap<String, String> singMap) {
    ...
    return DigestUtils.md5DigestAsHex(md5.toString().getBytes()).toUpperCase();
  }
}
